...
void Student::print() const{
  const char separator = ' ';
   ...
   cout << left << setw(1) << setfill(separator) << "ID: ";
   cout << left << setw(15) << setfill(separator) << id;
   cout << left << setw(1) << setfill(separator) << "Major: ";
   cout << left << setw(1) << setfill(separator) << major;
   cout << endl;
   cout << left << setw(1) << setfill(separator) << "Name: ";
   cout << left << setw(15) << setfill(separator) << name;
   cout << left << setw(1) << setfill(separator) << "GPA: ";
   cout << left << setw(1) << setfill(separator) << gpa;
